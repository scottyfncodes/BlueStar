...
export const assumptions: Assumption[] = [
  ...
  },
  {
    ...
    evidenceIds: ['EV-030'],
    whyThisValue:
      'DERIVED from the observed cohorts: 11 of 33 weekly visits are 60-minute Early Intervention visits. This replaces the earlier approximate 50/50 estimate, which overstated EI and therefore overstated the weighted visit length. Note this is the share of VISITS, which is what drives visit duration — the share of PATIENTS is different (44%) because EI children are seen weekly while some non-EI children are seen twice weekly.',
    confidence: 'Strong evidence',
    financialImpact: 'Critical',
    operationalImpact: 'Critical',
    whatWouldInvalidate:
      'Any shift in referral sources. Still the largest capacity lever: under flat per-visit pay, a 60-minute EI visit earns what a 30-minute visit earns while consuming twice the patient-facing time.',
    lastVerified: '2026-09-18',
    revisitDate: '2026-12-01',
  },
  {
  ...
  },
  {
    ...
    evidenceIds: ['EV-030'],
    whyThisValue:
      'Observed: all 11 Early Intervention children are seen once weekly, at 60 minutes. Previously null — this was one of the two inputs that made the Founder Ramp a structure rather than a timeline.',
    confidence: 'Strong evidence',
    financialImpact: 'Critical',
    operationalImpact: 'Critical',
  ...
  },
  {
    ...
    evidenceIds: ['EV-030'],
    whyThisValue:
      'DERIVED from the observed cohorts: 14 non-EI children generate 22 weekly visits (6 seen once weekly, 8 seen twice weekly), giving 1.57 visits per patient per week. Non-EI children are seen MORE often than EI children despite shorter visits — which is why the EI patient share and EI visit share diverge.',
    confidence: 'Strong evidence',
    financialImpact: 'Critical',
    operationalImpact: 'Critical',
    whatWouldInvalidate: 'A change in the mix of once- versus twice-weekly non-EI plans of care.',
    lastVerified: '2026-09-18',
    revisitDate: '2027-03-01',
  },
  {
  ...
  },
  {
    ...
    evidenceIds: ['EV-030'],
    whyThisValue:
      'DERIVED: 11 of 25 children are Early Intervention. This is deliberately a separate assumption from AS-019, the EI share of VISITS (33%). The two diverge whenever the groups are seen at different frequencies, and they do here. A census model that splits patients must use this one; a model that computes visit duration must use AS-019. Conflating them misstates capacity in opposite directions.',
    confidence: 'Strong evidence',
    financialImpact: 'High',
    operationalImpact: 'Critical',
