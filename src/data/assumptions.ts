...
export const assumptions: Assumption[] = [
  ...
  {
    id: 'AS-015',
    name: 'Documentation concurrency',
    value: 1,
    unit: 'fraction (0 = all documentation adds schedule time, 1 = none does)',
    kind: 'ASSUMPTION',
    source: "MODELLING ASSUMPTION derived from Ellen's observed workload (EV-025)",
    evidenceIds: ['EV-025'],
    whyThisValue:
      'The share of documentation time absorbed into the existing clinical and travel workflow rather than becoming ADDITIONAL schedule time. It is NOT a claim that notes are written while treating a child. Modelled at 1.0 because that is what the reported 60-minute cycle (45 patient-facing + 15 travel) implies arithmetically — but Ellen said "MOST" documentation is completed during the visit, not all, so 1.0 is a modelling convenience, not her reported behaviour.',
    confidence: 'Unverified',
    financialImpact: 'High',
    operationalImpact: 'Critical',
    whatWouldInvalidate:
      'Sensitivity testing shows the 8-visit day closes ONLY at exactly 100% concurrency: 8 x 60 = 480 minutes against a 480-minute workday, with zero slack. At 99% the cycle becomes 60.05 minutes and the ceiling drops to 7 visits. Since Ellen said "most" rather than "all", the true value is almost certainly below 1.0 — which would mean the real ceiling is 7 visits/day, not 8. This is the single most consequential unverified number in the model.',
    lastVerified: '2026-09-18',
    revisitDate: '2026-10-15',
  },
  {
